const TermsOfService = () => {
  return (
    <div className="flex flex-col w-8/12 mx-auto mt-10 mb-20 border-4 border-button border-dashed rounded-lg p-10  text-neutral-600">
      <div className="text-left">
        <h1 className="text-2xl font-bold text-center text-button mb-10">
          利用規約
        </h1>
        <p className="Inner-Text-first">
          この利用規約（以下，「本規約」といいます。）は，ヨガ図鑑（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザー（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <div className="Inner-Box">
          <h2 className="Inner-Box-Headline">第1条（適用）</h2>
          <p>
            本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。当社は本サービスに関し，本規約の他，ご利用にあたってのルール等，各種定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。本規約の規定が前条の個別規定の規定と矛盾する場合には，個別規定において特段の定めなき限り，個別規定の規定が優先されるものとします。
          </p>
          <h2 className="Inner-Box-Headline">
          ...
          <h2 className="Inner-Box-Headline">第3条（禁止事項）</h2>
          <p className="Inner-Box-Headline">
          ...
          <div className="Inner-Box-List">
            ...
            <li>
              当社，本サービスの他のユーザーまたは第三者の知的財産権，肖像権，プライバシー，名誉その他の権利または
            </li>
            <li>利益を侵害する行為</li>
            <li>
          ...
          <div className="Inner-Box-List">
            <li className="Inner-Box-List">
              当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。本サービスにかかるコンピュータシステムの保守点検または更新を行う場合地震，落雷，火災，停電または天災などの不可抗力により，本サービスの提供が困難となった場合コンピュータまたは通信回線等が事故により停止した場合その他，当社が本サービスの提供が困難と判断した場合当社は，本サービスの提供の停止または中断により，ユーザーまたは第三者が被ったいかなる不利益または損害についても，一切の責任を負わないものとします。
            </li>
          </div>
          <h2 className="Inner-Box-Headline">第5条（著作権）</h2>
          <div className="Inner-Box-List">
            <li>
          ...
          <h2 className="Inner-Box-Headline">第8条（サービス内容の変更等）</h2>
          <div className="Inner-Box-List">
            <li>
              当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
            </li>
          </div>
          <h2 className="Inner-Box-Headline">第9条（利用規約の変更）</h2>
          <div className="Inner-Box-List">
            <li>
          ...
          <h2 className="Inner-Box-Headline">第10条（個人情報の取扱い）</h2>
          <div className="Inner-Box-List">
            <li>
              当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
            </li>
          </div>
          <h2 className="Inner-Box-Headline">第11条（通知または連絡）</h2>
          <div className="Inner-Box-List">
            <li>
          ...
          <h2 className="Inner-Box-Headline">第12条（権利義務の譲渡の禁止）</h2>
          <div className="Inner-Box-List">
            <li>
              ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
            </li>
          </div>
          <h2 className="Inner-Box-Headline">第13条（準拠法・裁判管轄）</h2>
          <div className="Inner-Box-List">
          ...
          <p className="Outer-Flex-Text">以上</p>
